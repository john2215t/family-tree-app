...
class HelpScreen extends StatelessWidget {
  ...
  static const _items = <({String icon, String title, String body})>[
    ...
    (
      ...
      title: 'پروفایل فرد',
      body:
          'پروفایل هر فرد شامل سال تولد، وضعیت (با نشانگر رنگی)، محل دفن (برای درگذشتگان و شهیدان)، همسر، والدین، فرزندان، شمارش نسل‌ها و دکمه «مشاهده در خانواده اصلی» است. دکمه «سلسله پدری» زنجیره پدر، پدربزرگ و … را نشان می‌دهد.',
    ),
    (
      icon: '🟢🟡⚫',
