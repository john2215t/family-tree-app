...
/// This is a secondary view for getting a bird's-eye picture of the whole
/// clan — the app's primary navigation model is still the step-by-step
/// [FamilyScreen]. Tapping any node here jumps straight into the
/// step-by-step view at that generation.
class TreeScreen extends StatelessWidget {
  final FamilyRepository repository;

  const TreeScreen({super.key, required this.repository});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('نمای درختی')),
      body: InteractiveViewer(
        ...
        child: Padding(
          ...
          child: _TreeNode(
            ...
            familyId: repository.rootFamilyId,
            path: [repository.rootFamilyId],
          ),
        ),
      ),
    );
